...
const GenerateLink = () => {
    ...
    return (
        <Box minH={'100vh'} w={['100%', '100%', '100%', '60%']} bg={'white'} m={'auto'}>
            <Flex display={['box', 'box', 'flex']} fontSize={20} fontWeight={700}>
            ...
            <Flex color={'white'} fontSize={15} fontWeight={700} bg={'#041982'}>
                ...
                <Box p={5} fontSize={25} display={['box', 'box', 'none']} ><GiHamburgerMenu /></Box>
                <Spacer />
                <Box p={5} fontSize={25} ><BiSearchAlt2 /></Box>
            </Flex>
            <Flex p={10} display={['box', 'box', 'flex']} >
            ...
            <Box m={'auto'} w={'fit-content'} onClick={handleToggle} >
                {toggle === true ? (
                    ...
                    <Button fontSize={40} p={10} colorScheme='messenger'>Scrool Down</Button>
                )}
            </Box>
            <Text p={10} fontSize={35} fontWeight={700}>Top 10 Forex Risk Management Tips For Beginners</Text>
            <Flex display={['box', 'box', 'flex']}>
                <Box p={5} w={['fit-content', 'fit-content', '70%']} m={'auto'}>
            ...
            <Box m={'auto'} w={'fit-content'}>
                <Button onClick={handleLinks} fontSize={40} p={10} colorScheme='messenger'>Click Here...</Button>
            </Box>
            <Box m={10} w={'50%'} >
                <iframe src="https://www.youtube.com/embed/KRf4HPH5SEE" title="10 Forex Risk Management Strategies You Must Know" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </Box>
            <Box bg={'#4285f4'}>
