...
const Pagination = () => {
    const {page, setPage,skip,movies} = useContext(AuthContext) ;
    return (
        <Flex fontWeight={700} fontSize={20} w={'fit-content'} m={'auto'} >
            ...
            <Button 
            isLoading={skip === 12 }
             spinner={'none'} m={10} color={'#f17a1f'} border={'1px solid #f17a1f'} bg={'none'} onClick={() => setPage(page + 1)}>Next</Button>
        </Flex>
    )
}
